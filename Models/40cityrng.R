...
setwd("C:/Users/Kevin/Dropbox/PhD/psych234/city40_rand")
...
setwd("C:/Users/Kevin/Dropbox/PhD/psych234/city40_rand/solution")
...
myinits <- list( list(gamma = rep(1,82) ))
parameters <- c("gamma")

setwd("C:/Users/Kevin/Dropbox/PhD/psych234")
samples40rng <- jags(data, inits=myinits, parameters,
...
plot(samples40)
mean.gamma <- samples40$BUGSoutput$mean$gamma
simlist.gamma <- samples40$BUGSoutput$sims.list

#some plotting options to make things look better:
par(cex.main = 1.5, mar = c(5, 6, 4, 5) + 0.1, mgp = c(3.5, 1, 0), cex.lab = 1.5,
    font.lab = 2, cex.axis = 1.3, bty = "n", las=1)

mcmc <- as.mcmc(samples40)
plot(mcmc)
