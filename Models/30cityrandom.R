...
setwd("C:/Users/Kevin/Dropbox/PhD/psych234/city30_rand")
...
setwd("C:/Users/Kevin/Dropbox/PhD/psych234/city30_rand/solution")
...
myinits <- list( list(gamma = rep(1,30) ))
parameters <- c("gamma")

setwd("C:/Users/Kevin/Dropbox/PhD/psych234")
samples30rng <- jags(data, inits=myinits, parameters,
